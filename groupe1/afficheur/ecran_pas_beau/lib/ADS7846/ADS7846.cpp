...
#ifndef CAL_POINTT_X1
# define CAL_POINTT_X1   20
# define CAL_POINTT_Y1   20
# define CAL_POINTT1     {CAL_POINTT_X1,CAL_POINTT_Y1}
# define CAL_POINTT_X2   LCD_WIDTH-20 //300
# define CAL_POINTT_Y2   LCD_HEIGHT/2 //120
# define CAL_POINTT2     {CAL_POINTT_X2,CAL_POINTT_Y2}
# define CAL_POINTT_X3   LCD_WIDTH/2   //160
# define CAL_POINTT_Y3   LCD_HEIGHT-20 //220
# define CAL_POINTT3     {CAL_POINTT_X3,CAL_POINTT_Y3}
#endif
...
uint_least8_t ADS7846::setCalibration(CAL_POINTT *lcd, CAL_POINTT *tp)
{
...
uint_least8_t ADS7846::writeCalibration(uint16_t eeprom_addr)
{
  if(tp_matrix.div != 0)
  {
    ...
    eeprom_write_block((void*)&tp_matrix, (void*)eeprom_addr, sizeof(CAL_MATRIXT));
    return 1;
  }
...
uint_least8_t ADS7846::readCalibration(uint16_t eeprom_addr)
{
  ...
  if(c == 0x55)
  {
    eeprom_read_block((void*)&tp_matrix, (void*)eeprom_addr, sizeof(CAL_MATRIXT));
    return 1;
  }
...
{
  uint_least8_t i;
  CAL_POINTT lcd_points[3] = {CAL_POINTT1, CAL_POINTT2, CAL_POINTT3}; //calibration point postions
  CAL_POINTT tp_points[3];
