...
#include "../QamFlightInstruments-0.4/qaltimeter.h"
...
const QMetaObject QAltimeter::staticMetaObject = {
    { &QamFlightInstrument::staticMetaObject, qt_meta_stringdata_QAltimeter.data,
      qt_meta_data_QAltimeter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QAltimeter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QAltimeter.stringdata0))
        return static_cast<void*>(const_cast< QAltimeter*>(this));
